      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-lg bg-emerald-500/10 border border-emerald-500/30 px-3 py-2 flex items-center gap-2">
            ...
            <span className="text-xs text-emerald-300 font-medium">Proof added</span>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="journey-stage space-y-3">
      ...
      <div className="space-y-2 pt-1">
        {["Policy check passed", "Ticket auto-validated", "Warden notified"].map((t, i) => (
...
function StageLog() {
  const rows = [
    { t: "21:32:04", a: "QR scanned · Gate 1", c: "text-cyan-300" },
    { t: "21:32:04", a: "Hash written to ledger", c: "text-emerald-300" },
    { t: "21:32:05", a: "Integrity: 100% match", c: "text-emerald-300" },
  ];
  return (
    <div className="journey-stage space-y-3">
      <div className="flex items-center justify-between">
        <span className="text-[10px] font-bold uppercase tracking-widest text-cyan-300">Tamper-Proof Log</span>
      ...
      <div className="flex items-center gap-2 text-xs text-cyan-300 font-semibold">
        <MapPin className="h-3.5 w-3.5" /> Full audit trail available to admins
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-4 reveal">
