        ...
        <div className="grid gap-4">
          {visible.map((a) => {
            ...
            return (
              <article
                key={a._id}
                className={`min-w-0 rounded-3xl border bg-white p-4 shadow-sm sm:p-5 ${a.status === "Active" ? "border-rose-200 ring-1 ring-rose-100" : "border-slate-200"}`}
              >
                  ...
                  <div className="flex min-w-0 items-start gap-3 sm:gap-4">
                    ...
                    <div className="min-w-0">
                      <div className="flex min-w-0 flex-wrap items-center gap-2">
                        <h3 className="break-words text-base font-bold text-slate-900">{meta.label}</h3>
                ...
                <div className="mt-4 min-w-0 rounded-2xl border border-slate-100 bg-slate-50/70 p-3 sm:p-4">
                  ...
                  <div className="flex min-w-0 items-center gap-3">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-cyan-400 text-sm font-bold text-white">
                      {getInitials(student.name)}
                    </div>
                    <div className="min-w-0">
                      <p className="break-words text-sm font-bold text-slate-900">{student.name || "Unknown student"}</p>
