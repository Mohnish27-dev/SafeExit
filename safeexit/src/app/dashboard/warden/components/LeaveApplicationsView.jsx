      ...
      <div className="mt-6 space-y-3">
        {loading ? (
          ...
          pending.map((req, i) => (
            <div
              key={req.id}
              className="sd-luxe-card sd-luxe-rise sd-luxe-tilt rounded-2xl px-4 py-3.5"
                ...
                {rejectingId !== req.id && (
                  <div className="flex shrink-0 flex-col gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 rounded-2xl px-4 py-2 bg-linear-to-r from-violet-700 via-violet-600 to-fuchsia-500 text-white font-bold shadow hover:-translate-y-0.5 transition-transform"
                    >
