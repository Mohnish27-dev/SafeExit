	...
	const submitQuickSetup = async () => {
		...
		try {
			const profile = JSON.parse(
				localStorage.getItem("safeexit_guard_profile"),
			);
						...
						<div className="flex flex-col items-center text-center animate-fade-in-up">
							...
							>
								...
								<button
									type="submit"
									disabled={
										isProcessing || loginPin.length < 4
									}
								...
								>
									<div className="text-center mb-2">
										...
										<p className="text-sm text-slate-500 mt-1.5">
											Sign in with the Guard ID and PIN
									...
									<div>
										...
										<p className="text-xs text-slate-400 mt-1.5 pl-0.5">
											Use the unique Guard ID provided by
											your institution.
										</p>
									</div>
									...
									<div>
										...
										<p className="text-xs text-slate-400 mt-1.5 pl-0.5">
											Set by your administrator. Forgot
											it? Ask them to reset it.
										</p>
									</div>
					...
					<div className="bg-indigo-50/70 border border-indigo-100/80 rounded-xl px-4 py-3.5 flex items-center gap-3.5 hover:bg-indigo-50 transition-colors duration-300 group cursor-default">
						...
						<div>
							...
							<p className="text-xs text-slate-500 mt-0.5">
								Contact your administrator or caretaker for
								assistance.
							</p>
						</div>
					</div>
